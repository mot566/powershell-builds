...
$VendorURL = "https://www.mozilla.org/nl-NL/firefox/new/"
...
$DownloadLink = "https://download.mozilla.org/?product=firefox-esr-msi-latest-ssl&os=win64&lang=nl"

# Name of the downloaded installer file
$InstallerName = "FirefoxSetup.msi"
...
# Install the application
$ProcessExitCode = RunProcess "msiexec.exe" "/I $Installer ALLUSERS=1 TASKBAR_SHORTCUT=false INSTALL_MAINTENANCE_SERVICE=false PREVENT_REBOOT_REQUIRED=true /qn" $True
